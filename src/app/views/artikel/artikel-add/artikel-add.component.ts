...
@Component({
  templateUrl: 'artikel-add.component.html',
  styleUrls: ['artikel-add.component.scss'],
  encapsulation: ViewEncapsulation.None
})

export class ArtikelAddComponent implements OnInit {

  public loading = false;
  public url_api = environment.apiUrl.slice(0, -1);
  private url_artikel = environment.apiUrl + 'artikel';
  private url_artikel_category = environment.apiUrl + 'artikel_category';
  ...
  getCategory() {
    const url = this.url_artikel_category;
    this.loading = true;
    this.httpClient
    .get(url, {
      reportProgress: true,
  ...
  onSubmit() {
    const params = '';
    const url = this.url_artikel + params;
