...
export class SliderEditComponent implements OnInit {
  ...
  private url_slider = environment.apiUrl + 'slider';
  private url_slider_category = environment.apiUrl + 'slider_category';
  ...
  getCategory() {
    const url = this.url_slider_category;
    this.loading = true;
    this.httpClient
    .get(url, {
      reportProgress: true,
  ...
  getData() {
    ...
    const url = this.url_slider + params;
    const jsonData = {};
