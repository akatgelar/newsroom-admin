...
@Component({
  templateUrl: 'koran-edit.component.html',
  styleUrls: ['koran-edit.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class KoranEditComponent implements OnInit {

  public loading = false;
  public url_api = environment.apiUrl.slice(0, -1);
  private url_koran = environment.apiUrl + 'koran';
  private url_koran_category = environment.apiUrl + 'koran_category';
  ...
  summernoteConfig = {
    ...
    toolbar: [
        ...
        ['insert', ['table', 'link', 'picture', 'koran', 'hr', 'codeview']]
    ],
  ...
  getCategory() {
    const url = this.url_koran_category;
    this.loading = true;
    this.httpClient
    .get(url, {
      reportProgress: true,
  ...
  getData() {
    ...
    const url = this.url_koran + params;
    const jsonData = {};
